...
bot = InstaBot(login="12thandhyde", password='Fine9955',
               like_per_day=1000,
               comments_per_day=0,
               tag_list=['adashoreband', 'underoath', 'anberlin', 'saosin', 'posthardcore', 'metalcore', 'emo', 'screamo', 'thrice', 'fromfirsttolast', 'popmetal', 'rocknroll', 'coheed', 'coheedandcambria'],
               tag_blacklist=[],
               user_blacklist={},
